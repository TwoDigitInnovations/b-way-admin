...
const NotificationToast = ({ notification, onClose }) => {
  ...
  return (
    <div
      className={`min-w-sm w-full ${getBgColor()} border rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 ease-in-out`}
    >
      <div className="p-4">
...
const RealtimeNotifications = () => {
  ...
  return (
    <div className="fixed top-24 right-4 z-50 space-y-2">
      {/* <NotificationToast
          key={1}
          notification={"riuiwuergwegregwrgeigh"}
