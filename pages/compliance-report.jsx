...
function Compliances({ loader }) {
  ...
  const loadComplianceReports = async () => {
    try {
      ...
      setComplianceData([]); // Set empty array on error
    } finally {
      loader(false);
    }
  };
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setDashboardData(null); // Set null on error to avoid rendering issues
    }
  };
    ...
    try {
      if (modalMode === "add") {
        ...
        const response = await Api(
          "put",
          `/compliance/${selectedFacility._id}`,
          { updateData: formData }
        );
        if (response.data.status) {
          loadComplianceReports();
  ...
  return (
    <Layout title="Compliance Reports">
      ...
      <div className="bg-white shadow-sm overflow-hidden rounded-lg">
        ...
        {/* Table */}
        <DataTable
          value={Array.isArray(complianceData) ? complianceData : []}
          stripedRows
...
function Step1Content({ formData, handleInputChange }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
      <div className="space-y-2">
        <label className="block text-sm font-medium text-gray-700">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange("totalDeliveries", parseInt(e.target.value) || 0)
          }
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange("audit", parseInt(e.target.value) || 0)
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          min="0"
        />
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange("violation", parseInt(e.target.value) || 0)
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          min="0"
        />
      ...
      <div className="md:col-span-2 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="text-3xl font-bold text-blue-600">
          {formData.audit > 0
            ? (
                ((formData.audit - formData.violation) / formData.audit) *
                100
              ).toFixed(1)
            : 0}
          %
        ...
        <p className="text-sm text-gray-600">
          {formData.audit - formData.violation} compliant out of{" "}
          {formData.audit} audited deliveries
        </p>
      </div>
    </div>
  );
}
function Step2Content({ formData, handleInputChange }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.patientDataEncrypted",
                e.target.checked
              )
            }
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.accessLogsComplete",
                e.target.checked
              )
            }
            className="h-4 w-4 text-blue-600 rounded"
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.businessAssociateAgreements",
                e.target.checked
              )
            }
            className="h-4 w-4 text-blue-600 rounded"
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.auditTrailComplete",
                e.target.checked
              )
            }
            className="h-4 w-4 text-blue-600 rounded"
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.unauthorizedAccessAttempts",
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange(
                "hipaaCompliance.dataBreachIncidents",
                parseInt(e.target.value) || 0
              )
            }
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function Step3Content({ formData, handleInputChange }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
      <div className="space-y-2">
        <label className="block text-sm font-medium text-gray-700">
          Total Monitored Deliveries
        </label>
        <input
          type="number"
          ...
          onChange={(e) =>
            handleInputChange(
              "coldChainCompliance.totalMonitoredDeliveries",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "coldChainCompliance.temperatureExcursions",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "coldChainCompliance.averageTemperature",
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "coldChainCompliance.sensorCoveragePercentage",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function Step4Content({ formData, handleInputChange }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
      <div className="space-y-2">
        <label className="block text-sm font-medium text-gray-700">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "chainOfCustodyCompliance.completeDocumentationRate",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "chainOfCustodyCompliance.signatureCompletionRate",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "chainOfCustodyCompliance.deliveryConfirmationRate",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            handleInputChange(
              "chainOfCustodyCompliance.gpsTrackingCoverage",
              parseInt(e.target.value) || 0
            )
          }
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
